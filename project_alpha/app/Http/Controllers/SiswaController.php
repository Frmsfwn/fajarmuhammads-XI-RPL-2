...
class SiswaController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		Session::flash('tempattanggal_lahir',$request->tempattanggal_lahir);
		...
		$request->validate([
			...
			'tempattanggal_lahir.required'=>'Tempat dan Tanggal Lahir belum diisi!',
		...
		$data = [
			...
			'tempattanggal_lahir' => $request->tempattanggal_lahir,
    ...
    {   
        $request->validate([
            "nis" => [
                "required",
                Rule::unique('siswa','nis')->ignore($id, 'nis'),
            ],
			'nama'=>'required',
			'jenis_kelamin'=>'required',
			'tempattanggal_lahir'=>'required',
