			...
			<table>
				<tbody>
					...
					<tr>
						...
						<td> : </td>
						<td>
							<input type="text" name="tmpt_lahir" value="{{ $data->tmpt_lahir }}" id="tmpt_lahir">
						</td>
					</tr>
					<tr>
						<td> Tanggal Lahir </td>
						<td> : </td>
						<td>
							<input type="date" name="tgl_lahir" value="{{ $data->tgl_lahir }}" id="tgl_lahir">
						</td>
					</tr>
					<tr>
						<td> Alamat </td>
					...
					<tr>
						...
						<td></td>
						<td>
							<input type="submit" name="simpan" value="Simpan" onclick="return confirm('Apakah Anda ingin menyimpan data ini?')">
