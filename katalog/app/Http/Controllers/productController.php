...
class productController extends Controller
{
    ...
    {   
        ...
        product::create([
            'id'=> IdGenerator::generate(['table' => 'product', 'length' => 10, 'prefix' =>'PROD-', 'reset_on_prefix_change'=>true]),
    ...
    function addlike(product $product)
    {
        ...
        if($Like){
            ...
            $like = new like();
            $like->id = IdGenerator::generate(['table' => 'like', 'length' => 10, 'prefix' =>'LIKE-', 'reset_on_prefix_change'=>true]);
